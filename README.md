...
class AdityaYadav:
    ...
    def core_stack(self) -> dict:
        return {
            "intelligence": ["LLMs", "RAG", "LangChain", "FAISS", "Generative AI"],
            "ml_engineering": ["scikit-learn", "TensorFlow", "PyTorch", "AutoML"],
            "vision": ["OpenCV", "MediaPipe", "Real-Time Pipelines"],
    ...
    def philosophy(self) -> list[str]:
        return [
            "Systems, not scripts — config-driven, reproducible, deployable",
...
Ingestion: PDF, DOCX, PPTX, TXT, Audio, Video → semantic chunking → embeddings → FAISS vector search
Privacy: Local storage, encrypted API keys, audit logging, transparent outbound monitoring
...
https://github.com/adityayadav161003
...
Gesture classification with smoothing and debouncing for stable interaction
Full CV pipeline: landmark detection → gesture mapping → system action
Stack: Python OpenCV MediaPipe Computer Vision
https://github.com/adityayadav161003/GestureWave-AI
...
Config-driven experiments with full artifact management
Reduced repetitive setup by 15% through automation
Stack: Python scikit-learn Pandas Streamlit
https://github.com/adityayadav161003/ay-systems
...
https://github.com/adityayadav161003/Netflix-Data-Analysis
...
https://github.com/adityayadav161003/IPL-Data-Analytics
...
for epoch in range(2022, 2027):
    ...
    if epoch == 2024:
        ...
        experience = {
            ...
            "achievements": [
                "Built fraud detection model with ~85-90% accuracy (TensorFlow)",
                "Engineered Java data pipeline (+20% throughput)",
                "Developed LLM synthetic data PoC (+10% model robustness)",
                "Owned full lifecycle: ingestion → preprocessing → training → evaluation"
            ]
        }
        ...
        experience = {
            ...
            "projects": ["Orvika AI", "AY Systems", "GestureWave AI"],
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <img height="170" src="https://github-readme-stats.vercel.app/api/top-langs/?username=adityayadav161003&layout=compact&theme=dark&bg_color=0d1117&border_color=00d4ff30&title_color=ffffff&text_color=888888" />
</p>
<p align="center">
...
Technology Job Simulation	Deloitte Australia	2024
Generative AI & RAG System Development	Orvika AI (Self-Directed)	2025
AI Product Design & Architecture	Independent Build	2025
Get In Touch — The Inference API
plain
POST /contact
Host: adity6946@gmail.com
Content-Type: application/json

{
  "role": "AI/ML Engineering Internship",
  "timeline": "2026",
  "context": "Brief description of the opportunity",
  "expected_response_time": "< 24 hours"
}
Table
Endpoint	URL	Use Case
Portfolio	ay-systems-iota.vercel.app	Full work, case studies, lab experiments
LinkedIn	aditya-yadav-570846289	Professional connect
GitHub	@adityayadav161003	Code and repos
Email	adity6946@gmail.com	Fastest response — include role + timeline
<p align="center">
  <a href="mailto:adity6946@gmail.com">
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:0a1628,100:000000&height=120&section=footer&text=I%20build%20things%20that%20think.&fontSize=24&fontColor=00d4ff&fontAlignY=65" />
</p>
<p align="center">
